...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third order-md-last img js-fullheight" style="background-image:url({{ url('home/images/bg_1.jpg') }});">
	          		<div class="overlay"></div>
	          	</div>
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third order-md-last img js-fullheight" style="background-image:url({{ url('home/images/bg_2.jpg') }});">
	          		<div class="overlay"></div>
	          	</div>
		          <div class="one-forth d-flex js-fullheight align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
    ...
    <section class="ftco-section-2 img" style="background-image: url({{ url('home/images/bg_3.jpg') }});">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <div class="carousel-project owl-carousel">
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ asset('home/images/project-1.jpg') }}" class="img-fluid" alt="Colorlib Template">
				    				<div class="text px-4">
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ asset('home/images/project-2.jpg') }}" class="img-fluid" alt="Colorlib Template">
				    				<div class="text px-4">
				    					<h3><a href="#">Work Name</a></h3>
				    					<span>Web Design</span>
				    				</div>
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ asset('home/images/project-3.jpg') }}" class="img-fluid" alt="Colorlib Template">
				    				<div class="text px-4">
				    					<h3><a href="#">Work Name</a></h3>
				    					<span>Web Design</span>
				    				</div>
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ asset('home/images/project-4.jpg') }}" class="img-fluid" alt="Colorlib Template">
				    				<div class="text px-4">
				    					<h3><a href="#">Work Name</a></h3>
				    					<span>Web Design</span>
				    				</div>
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ asset('home/images/project-5.jpg') }}" class="img-fluid" alt="Colorlib Template">
				    				<div class="text px-4">
				    					<h3><a href="#">Work Name</a></h3>
				    					<span>Web Design</span>
				    				</div>
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ asset('home/images/project-6.jpg') }}" class="img-fluid" alt="Colorlib Template">
				    				<div class="text px-4">
				    					<h3><a href="#">Work Name</a></h3>
				    					<span>Web Design</span>
				    				</div>
