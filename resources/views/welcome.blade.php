...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ asset('images/profil/'.$profil->logo) }}" height="80"/></a>
	  ...
	  <section id="home-section" class="hero">
	      ...
	      <div class="slider-item js-fullheight">
            ...
            <div class="row d-md-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
              ...
              @foreach ($about as $a)
              <div class="one-third order-md-last img js-fullheight" style="background-image:url({{ asset('images/about') }}/{{ $a->image }});">
                @endforeach
            ...
            <div class="overlay"></div>
		          ...
		          <div class="one-forth d-flex js-fullheight align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
			            ...
			            <p><a href="http://wa.me/{{ $profil->no_telepon }}/" class="btn btn-primary px-5 py-3 mt-3">Hubung Kami Via Whatsapp</a></p>
		            </div>
		          </div>
	        	</div>
	        </div>
        ...
        <div class="row no-gutters">
          <div class="col-md-4 ftco-animate py-5 nav-link-wrap">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              <a class="nav-link px-4 active" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="true"><span class="mr-3 flaticon-box"></span> Produk Yang Tersedia</a>
              </div>
          </div>
    ...
    <section class="ftco-section ftco-project bg-light" id="projects-section">
            ...
            <div class="carousel-project owl-carousel">
              @foreach ($slider as $key =>  $item)
            	<div class="item {{$key == 0 ? 'active' : '' }}">
            		<div class="project">
                  <div class="img">
                    <img src="{{ asset('images/slider') }}/{{ $item->slider_photo }}" class="img-fluid" alt="Colorlib Template">
				    				<div class="text px-4">
    	...
    	<div class="container">
            ...
            @foreach ($about as $about)
    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url({{ asset('images/about') }}/{{ $about->image }});">
              @endforeach
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-7 pl-lg-5 py-5">
    				<div class="py-md-5">
			          ...
			          <div class="col-md-12 heading-section ftco-animate">
			          	<span class="subheading">Selamat Datang Di {{ $profil->nama_aplikasi }}</span>
			            <h2 class="mb-4" style="font-size: 34px; text-transform: capitalize;">{{ $profil->informasi_aplikasi }}</h2>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">{{ $profil->alamat_lengkap }}</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">{{ $profil->no_telepon }}</span></a></li>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://github.com/fadhila36" target="_blank">Unifisyt</a>
